    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center px-4 py-8">
      ...
      >
        ...
        <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-1 sm:space-y-0">
                  <span className="text-gray-600 min-w-0">Email:</span>
                  <span className="font-mono bg-white px-2 py-1 rounded border text-gray-800 text-xs break-all">
                    demo@example.com
                  </span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-1 sm:space-y-0">
                  <span className="text-gray-600 min-w-0">Password:</span>
                  <span className="font-mono bg-white px-2 py-1 rounded border text-gray-800 text-xs">
                    demo123
                  </span>
                </div>
              </div>
              ...
              <button
                ...
                className="mt-3 w-full sm:w-auto text-xs text-blue-600 hover:text-blue-700 font-medium transition-colors bg-white hover:bg-blue-50 px-3 py-2 rounded-lg border border-blue-200"
              >
          ...
          <div className="text-center">
            <button
              ...
              className="inline-flex items-center justify-center w-full py-3 px-4 border border-gray-300 rounded-xl text-gray-700 bg-white hover:bg-gray-50 font-semibold transition-all duration-200 hover:shadow-md"
            >
              Create new account
            </button>
          </div>
        ...
        <div className="text-center mt-8 text-sm text-gray-500">
          <p>© 2025 Professional Network. Connecting careers worldwide.</p>
        </div>
      </div>
    </div>
  );
